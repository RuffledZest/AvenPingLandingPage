    ...
    <>
      ...
      <div className={cn("relative w-full max-w-sm mx-auto", className)}>
        <div className="liquidGlass-wrapper relative flex font-semibold overflow-hidden text-black cursor-pointer shadow-[0_6px_6px_rgba(0,0,0,0.2),0_0_20px_rgba(0,0,0,0.1)] transition-all duration-[400ms] ease-[cubic-bezier(0.175,0.885,0.32,2.2)] rounded-2xl md:rounded-3xl p-3 hover:p-4 hover:scale-[1.02] hover:shadow-[0_12px_12px_rgba(0,0,0,0.3),0_0_40px_rgba(0,0,0,0.2)]">
          ...
          {/* Content Layer */}
          <div className="liquidGlass-text z-[3] relative flex h-full flex-col gap-4 overflow-hidden rounded-xl p-6 bg-black/30 dark:bg-transparent backdrop-blur-lg w-full">
            ...
            <div className="text-center space-y-1">
              <h3 className="font-semibold text-lg text-white truncate">{songTitle}</h3>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <button
                ...
                className="p-3 rounded-full bg-gradient-to-r from-black to-zinc-900 hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg"
              >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 relative h-1 bg-white/10 rounded-full">
                <div
                  className="absolute left-0 top-0 h-full bg-gradient-to-r from-black to-zinc-900 rounded-full"
                  style={{ width: `${volume}%` }}
                />
              </div>
