...
import { MessageCircle, BarChart3, Users, Bot, Shield, Sparkles, Globe, Lock } from "lucide-react"
    ...
    <section className="py-24 bg-gradient-to-b from-white to-gray-50/80">
      <div className="container">
        ...
        <h2 className="text-6xl font-medium text-center mt-6 max-w-2xl m-auto text-gray-900">
          Everything you need for <span className="text-cyan-600">WhatsApp Business</span>
        </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                ...
                <div className="flex items-center justify-center gap-4">
                  <div className="flex items-center">
                    <Avatar className="z-40 border-2 border-cyan-500">
                      <Image src={avatar1 || "/placeholder.svg"} alt="Avatar 1" className="rounded-full" />
                    </Avatar>
                    <Avatar className="-ml-4 border-2 border-blue-500 z-30">
                      <Image src={avatar2 || "/placeholder.svg"} alt="Avatar 2" className="rounded-full" />
                    </Avatar>
                    <Avatar className="-ml-4 border-2 border-purple-500 z-20">
                      <Image src={avatar3 || "/placeholder.svg"} alt="Avatar 3" className="rounded-full" />
                    </Avatar>
                  ...
                  <div className="text-center">
                    <p className="text-2xl font-bold text-gray-900">8 Members</p>
            ...
            <motion.div variants={cardVariants}>
              ...
              >
                <div className="text-center space-y-4">
                  <div className="relative">
                    <Bot size={48} className="text-cyan-500 mx-auto animate-pulse" />
                    <Sparkles size={16} className="absolute -top-2 -right-2 text-yellow-500" />
                  </div>
                  <div className="space-y-1">
                    <p className="text-lg font-semibold text-gray-700">Always Available</p>
            ...
            <motion.div variants={cardVariants}>
              ...
              >
                <div className="text-center space-y-4">
                  <div className="relative">
                    <MessageCircle size={48} className="text-cyan-500 mx-auto" />
              ...
              >
                <div className="text-center space-y-4">
                  <div className="relative">
                    ...
                    <Lock size={16} className="absolute -bottom-1 -right-1 text-gray-600" />
                  </div>
                  <div>
