        ...
        <div className="container py-12">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              <h3 className="text-xl font-semibold text-gray-900">Join our newsletter to keep up to date with us!</h3>
            </div>
...
md:flex-row items-center justify-center md:justify-start
             gap-3 w-full md:w-auto">
              ...
              />
              <Link href="/signup">
                <Button size="sm" className="whitespace-nowrap" type="button" variant="primary">
                  Get Started
                </Button>
              </Link>
            </div>
      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 md:lg:gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-600 text-sm max-w-xs">A simple CRM that is easy to use and easy to manage</p>
          </div>
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="#" className="text-gray-600 text-sm hover:text-cyan-600 transition-colors">
                English
              </a>
              <a href="#" className="text-gray-600 text-sm hover:text-cyan-600 transition-colors">
                Privacy
            ...
            {/* Copyright */}
            <div className="text-gray-500 text-sm">© 2024 Aven Technologies Inc. All Rights Reserved.</div>
          </div>
        </div>
      </div>
    </footer>
